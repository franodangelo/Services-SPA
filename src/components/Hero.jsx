        ...
        <main name="home">
            <div className="w-full h-screen bg-zinc-100 flex flex-col justify-between text-slate-900">
                <div className="grid md:grid-cols-2 max-w-[1280px] m-auto">
                    ...
                    <div className="absolute flex flex-col py-4 md:min-w-[760px] bottom-[5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-white rounded-xl text-center shadow-lg">
