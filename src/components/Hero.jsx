...
export default function Hero() {
    return (
        <header name="home" className="flex flex-col w-full pt-[120px] md:pt-40 justify-between items-center bg-zinc-100 text-slate-900">
            ...
            <section className="flex flex-col w-[80%] sm:w-[75%] lg:w-[65%] xl:w-[50%] my-20 p-4 gap-4 text-center rounded-xl bg-white shadow-lg">
