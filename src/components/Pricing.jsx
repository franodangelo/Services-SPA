            ...
            <div className='max-w-[1280px] mx-auto py-12'>
                    ...
                    <section className='grid md:grid-cols-3'>
                        <div className='m-2 p-8 h-auto bg-white text-slate-800 rounded-xl shadow-2xl relative'>
                            <span className='px-4 py-1 bg-amber-200 text-amber-800 rounded-2xl font-sans font-semibold text-sm uppercase'>Standard</span>
                        ...
                        <div className='bg-white text-slate-800 m-2 p-8 rounded-xl shadow-2xl relative'>
                            <span className='px-4 py-1 bg-slate-600 rounded-2xl font-sans font-semibold text-sm text-amber-500 uppercase'>Pro</span>
