...
export default function Pricing() {
    return (
        <main className='w-full text-white my-24'>
            <div className='w-full h-[800px] bg-slate-800 absolute mix-blend-overlay'>
                <div className='max-w-[1280px] mx-auto py-12'>
                    ...
                    <section className='grid md:grid-cols-3'>
                        <div className='bg-white text-slate-800 m-2 p-8 rounded-xl shadow-2xl relative'>
                            ...
                            <ul className='text-lg relative'>
                                <li className='flex items-center'><CheckIcon className='w-12 mr-2 text-green-600' />Lorem ipsum dolor sit.</li>
                                <li className='flex items-center'><CheckIcon className='w-12 mr-2 text-green-600' />Lorem ipsum dolor sit.</li>
                                <li className='flex items-center'><CheckIcon className='w-12 mr-2 text-green-600' />Lorem ipsum dolor sit.</li>
                                <li className='flex items-center'><XIcon className='w-12 mr-2 text-red-600' />Lorem ipsum dolor sit.</li>
                                <li className='flex items-center'><XIcon className='w-12 mr-2 text-red-600' />Lorem ipsum dolor sit.</li>
                                <li className='flex items-center'><XIcon className='w-12 mr-2 text-red-600' />Lorem ipsum dolor sit.</li>
                                <li className='flex items-center'><XIcon className='w-12 mr-2 text-red-600' />Lorem ipsum dolor sit.</li>
                            </ul>
