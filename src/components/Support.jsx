        ...
        <main name="support" className="w-full py-16 sm:py-20 md:py-24 lg:py-32 px-10 md:px-16 lg:px-20 bg-slate-800 text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 mt-16 gap-16 lg:gap-6">
                <div className="bg-white rounded-xl shadow-2xl">
                    ...
                    <h3 className="flex pl-8 py-4 items-center text-lg text-amber-400 rounded-b-xl bg-slate-100">Download now <ArrowSmRightIcon className="w-5 ml-2" /></h3>
                </div>
                <div className="bg-white rounded-xl shadow-2xl">
                    <div className="p-8">
                    ...
                    <h3 className="flex pl-8 py-4 items-center text-lg text-amber-400 rounded-b-xl bg-slate-100">Contact us <ArrowSmRightIcon className="w-5 ml-2" /></h3>
                </div>
                <div className="bg-white rounded-xl shadow-2xl">
                    <div className="p-8">
                    ...
                    <h3 className="flex pl-8 py-4 items-center text-lg text-amber-400 rounded-b-xl bg-slate-100">Run a test <ArrowSmRightIcon className="w-5 ml-2" /></h3>
                </div>
            </div>
        </main>
    )
