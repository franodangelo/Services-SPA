        ...
        <main name='support' className='w-full my-32 bg-slate-800'>
            <div className='max-w-[1280px] mx-auto text-white relative'>
                <div className='px-4 py-12'>
                    ...
                    <p className='py-6 font-sans text-2xl text-center'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum quis pariatur eveniet beatae, voluptates esse inventore enim impedit ipsam soluta maiores quibusdam id repellat obcaecati sit incidunt dicta, blanditiis nemo!</p>
                </div>
