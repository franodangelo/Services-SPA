        ...
        <main className='w-full h-screen mt-24'>
            ...
            <div className='max-w-[1280px] mx-auto text-white relative'>
                ...
                <div className='px-4 py-12'>
                    <h1 className='text-5xl font-bold py-6 text-slate-300 text-center'>Support</h1>
                    <p className='text-2xl py-4 text-slate-300'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum quis pariatur eveniet beatae, voluptates esse inventore enim impedit ipsam soluta maiores quibusdam id repellat obcaecati sit incidunt dicta, blanditiis nemo!</p>
                </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        ...
                        <div className='bg-slate-100 pl-8 py-4 rounded-b-xl'>
                            <h3 className='flex items-center text-yellow-600'>Contact us <ArrowSmRightIcon className='w-5 mt-2' /></h3>
                        </div>
                    </div>
