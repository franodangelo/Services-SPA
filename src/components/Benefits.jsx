    ...
    return (
        <main className='w-full my-32'>
            <div className='max-w-[1280px] mx-auto px-2'>
                ...
                <p className='text-2xl py-8 text-slate-500 text-center'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquid facere incidunt odit, repudiandae cupiditate autem quibusdam iusto atque in nulla et dolorem. Porro delectus sunt enim non. Odio, dolor. Excepturi.
            ...
            <section className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4'>
                <div className='flex'>
                    ...
                    <div>
                        <h2 className='font-bold text-xl text-slate-500'>Notifications</h2>
