    ...
    return (
        <main name='benefits' className='w-full my-32'>
            <div className='max-w-[1280px] mx-auto px-2'>
                <h1 className='text-5xl font-bold py-6 text-center'>Benefits when working with us!</h1>
                <p className='py-6 font-sans text-2xl text-center text-slate-500'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquid facere incidunt odit, repudiandae cupiditate autem quibusdam iusto atque in nulla et dolorem. Porro delectus sunt enim non. Odio, dolor. Excepturi.
